...
let workoutThursday = data.filter((workout) => workout.day === "thursday");

const CustomizeTableThursday = () => {
  const [workouts, setWorkouts] = useState(workoutThursday);
...
export default CustomizeTableThursday;
