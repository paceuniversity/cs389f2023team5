...
let workoutFriday = data.filter((workout) => workout.day === "friday");

const CustomizeTableFriday = () => {
  const [workouts, setWorkouts] = useState(workoutFriday);
...
export default CustomizeTableFriday;
