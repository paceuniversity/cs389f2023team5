...
let workoutSunday = data.filter((workout) => workout.day === "sunday");

const CustomizeTableSunday = () => {
  const [workouts, setWorkouts] = useState(workoutSunday);
...
export default CustomizeTableSunday;
