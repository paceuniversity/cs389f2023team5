...
let workoutWednesday = data.filter((workout) => workout.day === "wednesday");

const CustomizeTableWednesday = () => {
  const [workouts, setWorkouts] = useState(workoutWednesday);
  ...
  return (
    <div className="customize-table">
      ...
      {showForm ? (
        ...
        <>
          <Button variant = 'contained' size = 'small' onClick={() => setShowForm(true)}>Add new Workout</Button>
        </>
      )}
    </div>
  );
...
export default CustomizeTableWednesday;
